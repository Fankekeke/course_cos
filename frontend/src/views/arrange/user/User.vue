...
export default {
  ...
  methods: {
    ...
    dataInit () {
      ...
      this.$get('/cos/teacher-info/user/info', {userId: this.currentUser.userId}).then((r) => {
        this.rowId = r.data.teacherInfo.id
        this.setFormValues(r.data.teacherInfo)
